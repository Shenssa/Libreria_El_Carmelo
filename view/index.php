            ...
            <div class="movie-list">
                ...
                <ul class="list">
                    ...
                    ?>
                        ...
                        <li>
                            <td><?php echo "<img src='" . $mostrar["portada"] . "'>"; ?></td>
                            ...
                            <?php echo "<button type='button' class='btn btn-primary btn-block' data-toggle='modal' data-target='#" . $mostrar['id'] . "'>" ?>
                            Ver mas detalles</button>

                            <!-- Modal -->

                            <?php echo "<div class='modal fade' id='" . $mostrar['id'] . "' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>" ?>
                            <div class='modal-dialog modal-lg' role='document'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        <?php echo "<h3 class='modal-title' id='exampleModalLongTitle'>" . $mostrar['nombre'] . "</h3>" ?>
                                    ...
                                    <div class='modal-body'>
                                        ...
                                        <table id='bootstrap-data-table' class='table table-striped table-bordered'>
                                            <tbody>
                                                <tr>
                                                    <?php echo "<td><img src='" . $mostrar['portada'] . "'></td>" ?>
                                                    <?php echo "<td>SINOPSIS: " . $mostrar['descripcion'] . "</td>" ?>
                                                <tr>
                                                <tr>
                                                    <b>
                                                        <td align='right'>Autor:</td>
                                                    </b>
                                                    <?php echo "<td>" . $mostrar['autor'] . "</td>" ?>
                                                <tr>
                                                <tr>
                                                    <b>
                                                        <td align='right'>Genero:</td>
                                                    </b>
                                                    <?php echo "<td><u><a style='color:#000000;' href='" . $mostrar["genero"] . ".php'>" . $mostrar['genero'] . "</a></u></td>" ?>
                                                <tr>
                                                <tr>
                                                    <b>
                                                        <td align='right'>Precioos:</td>
                                                    </b>
                                                    <?php echo "<td>" . $mostrar['precio'] . "</td>" ?>
                                                <tr>
                                            </tbody>
                                        </table>
                                    </div>
