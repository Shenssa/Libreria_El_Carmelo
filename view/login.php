                            ...
                            <article class="fondo">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);  ?>" class="" method="post" name="login">
                                    <input class="inp" name="email" type="email" value="" required="" placeholder="CORREO">
                                        <br>
                                            <input class="inp" name="pass" type="password" value="" required="" placeholder="CONTRASENA">
                                                <br>
                                                    <a class="he" href="">
                                                        He olvidado mi contraseña
                                                    </a>
                                                    <input class="boton" name="inicio" type="submit" value="Iniciar Sesión" >
                                                    </input>
                                                    <br><br>
                                                        <a class="he" href="registrate_db.php">
                                                            Registrarme
                                                        </a>
                                                    </br>
                                                </br>
